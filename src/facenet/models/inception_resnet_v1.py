...
class InceptionResnetV1(nn.Module):
	...
	CASIA-Webface datasets. Pretrained state_dicts are automatically downloaded
	on model instantiation if requested and cached in the torch cache.
	...
	def load_weights(self, name: str) -> None:
		...
		Arguments:
		    ...
		    name {str} -- Name of dataset that was used to generate pretrained
		        state_dict.

		Raises:
		    ValueError: If 'pretrained' not equal to 'vggface2'
		        or 'casia-webface'.
		"""
		if name == 'vggface2':
			...
			raise ValueError(
				'Pretrained models only exist for "vggface2" and '
				+ '"casia-webface"'
			)
